...
from dharitri_py_sdk import ApiNetworkProvider, NetworkProviderConfig
...
class CurrencyProvider:
    ...
    def _get_currency_metadata(self, token_identifier: str) -> Currency:
        if is_native_currency(token_identifier):
            return Currency(REWA_IDENTIFIER_FOR_MULTI_DCDTNFT_TRANSFER, "REWA", 18)
...
def is_native_currency(token_identifier: str) -> bool:
    return token_identifier == "" or token_identifier == REWA_IDENTIFIER_FOR_MULTI_DCDTNFT_TRANSFER
