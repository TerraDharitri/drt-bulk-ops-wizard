...
def _do_main(cli_args: list[str]):
    ...
    ux.confirm_continuation(
        f"Ready to do transfers, by sending [green]{len(transactions_wrappers)}[/green] transactions?"
    )

    print(
        f"Safety mechanism: you'll be asked again to re-confirm the transfers in {DELAY_TO_CAPTURE_ATTENTION_IN_SECONDS} seconds, [red]please pay attention[/red]!"
    )
