...
from dharitri_py_sdk import Address, VoteType
...
class GovernanceRecord:
    ...
    def load_many_from_proofs_file(cls, proofs_file: Path):
        ...
        records_by_adresses: dict[str, GovernanceRecord] = {item.address.to_bech32(): item for item in records}
...
def convert_string_to_vote_type(input: str) -> VoteType:
    ...
    return {"yes": VoteType.YES, "no": VoteType.NO, "abstain": VoteType.ABSTAIN, "veto": VoteType.VETO}[input]
